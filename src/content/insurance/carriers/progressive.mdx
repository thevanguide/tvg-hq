...
Progressive does not publish specific rate ranges for van conversion insurance. Based on the published range for Class B RV insurance generally and owner-reported figures, expect:
...
**Minimal builds.** If your conversion doesn't have all seven of Progressive's required habitation features — particularly the toilet and 110V electrical system — you won't qualify. Roamly and State Farm are more flexible on what constitutes a qualifying conversion.
...
**Agreed value on DIY builds.** How Progressive handles the insured value on a van with no factory MSRP is worth confirming at quoting. The gap between what you spent on the conversion and what the carrier will agree to insure it for can be significant. Ask specifically whether agreed value is available and what documentation is required.
