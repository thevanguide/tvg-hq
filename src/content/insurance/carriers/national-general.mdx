...
**Agreed value.** For units that do not qualify for full replacement cost, the policyholder and carrier agree on the insured value at binding. At total loss, the carrier pays the agreed amount without depreciation disputes. This is critical for custom and DIY builds where there is no factory MSRP.

**Personal belongings coverage.** Covers personal property stored in the van — tools, electronics, clothing, camping gear — up to a stated limit. Standard limits are higher than most competitors; additional coverage is available as a rider.
...
**Minimalist builds.** The indoor plumbing/toilet requirement disqualifies some budget and minimalist conversions. If your van has a portable toilet or no toilet at all, you may not qualify. Roamly and State Farm are more flexible.

**California Class B availability.** Good Sam / National General has historically had limited availability for Class B campervan insurance in California. This may have changed — verify at quoting — but California van owners should have a backup carrier in mind.

**No rental income coverage.** Like Progressive, Good Sam does not cover peer-to-peer rental income through Outdoorsy or RVshare. Roamly is the only major option for rental use.

**Quoting process.** Getting a Good Sam quote typically requires a phone call. The online quoting process routes you to a phone agent for RV products, especially for converted vans. This is slower than Roamly's online-first process or Progressive's web quoting for factory RVs.
...
| Full replacement cost | Yes (qualifying units) | Varies by underwriter | Yes (qualifying units) |
| Full-timer's depth | Strongest in market | Available | Available |
| Rental income | No | Yes | No |
| Multi-policy discount | Limited | No | Yes (significant) |
