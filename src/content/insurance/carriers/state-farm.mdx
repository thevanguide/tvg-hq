...
description: "State Farm doesn't advertise van conversion coverage, but some agents write it at competitive rates. What owners report and what to ask your agent."
...
State Farm is the most unpredictable option for [van conversion insurance](/insurance/). It does not advertise a van conversion product. Its corporate website does not mention DIY builds, custom conversions, or camper vans. There is no published underwriting guide for converted vehicles the way [National General](/insurance/carriers/national-general/) publishes one for Good Sam.
...
- [Good Sam vs State Farm](/insurance/compare/good-sam-vs-state-farm/) — structured RV product vs local agent flexibility
