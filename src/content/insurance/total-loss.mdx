...
description: "A total loss on a converted van is different from a total loss on a regular car. Here's how the claims process works, the difference between agreed value and actual cash value, and how to avoid a payout that doesn't cover your build."
...
**Who offers it:** [Good Sam / National General offers agreed value](https://uwguides.nationalgeneral.com/ppa/countrywideRV/uwg_rv_countrywide.pdf) specifically for "highly customized units without a Blue Book comparable" — which describes most van conversions. The [maximum agreed value under the National General guide is $300,000](https://uwguides.nationalgeneral.com/ppa/countrywideRV/uwg_rv_countrywide.pdf), with underwriting review required. Roamly offers agreed value through its [underwriter panel](https://www.roamly.com/about), with the specific terms depending on which carrier underwrites the policy. Progressive's published materials do not clearly offer agreed value for RV policies based on the available documentation.
