...
**Roamly.** Offers full-time coverage as a standard option in its campervan product. Because Roamly places policies through multiple underwriters, the specific full-timer's terms vary by which carrier underwrites the policy. Roamly's quoting process asks about full-time use upfront and routes accordingly. See the [Roamly carrier review](/insurance/carriers/roamly/) for details on the product structure.

**Good Sam / National General.** One of the longest-running full-timer's products in the RV insurance market. The Good Sam full-timer's endorsement includes total loss replacement (for qualifying units), personal effects up to $25,000, emergency expense coverage, and vacation liability. The product was designed for the full-time RV community and has been available for decades. The key requirement for converted vans: the build must include permanently installed cooking, sleeping, plumbing, and bathroom facilities — Good Sam's definition is stricter than some competitors.

**Progressive.** Offers a full-timer's option on its RV product, including for DIY van conversions (since November 2023). Progressive's full-timer's coverage adds personal liability, medical payments to others, and increased personal property limits. Progressive's quoting process asks specifically whether the RV is a primary residence.
