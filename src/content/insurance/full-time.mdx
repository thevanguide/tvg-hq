...
**Progressive.** Offers a full-timer's option on its [RV insurance product](https://www.progressive.com/rv/coverages/), including for DIY van conversions ([since November 2023](https://rvbusiness.com/progressive-adds-coverage-for-diy-camper-van-conversions/)). Progressive's full-timer's coverage adds personal liability, medical payments to others, and increased personal property limits. Emergency expense coverage increases to [up to $7,500 for full-timers](https://www.progressive.com/answers/motorhome-insurance-coverages/) (vs. $750 for recreational use). Progressive's quoting process asks specifically whether the RV is a primary residence.
...
**USAA.** Available to military families. Offers full-timer's coverage on Class B RVs, including converted vans, with competitive rates for eligible members.
...
- [Progressive — RV Insurance Full-Timer Coverage](https://www.progressive.com/rv/coverages/) — full-timer's endorsement details and eligibility
