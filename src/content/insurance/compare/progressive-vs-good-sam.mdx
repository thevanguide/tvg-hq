...
description: "Comparing Progressive and Good Sam for converted van insurance: build requirements, settlement options, discounts, California availability, and which is the better fit for your van."
...
**Good Sam / National General does not.** The [underwriting guide](https://uwguides.nationalgeneral.com/ppa/countrywideRV/uwg_rv_countrywide.pdf) explicitly excludes Class B van conversions in California. For the significant van conversion population in Los Angeles, San Diego, the Bay Area, and Orange County, Good Sam is not an option for the van itself.
