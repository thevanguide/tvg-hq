...
You can check whether your registration address falls within a DEQ testing boundary using the [DEQ boundary lookup tool](https://www.deq.state.or.us/VIP/).
...
**Assuming DEQ does not apply.** If you live in the Portland or Medford metro area, your van conversion may need a DEQ emissions test before you can register it, even as a motor home. Check the [boundary lookup tool](https://www.deq.state.or.us/VIP/) before your DMV visit. Showing up without a DEQ certificate when one is required will stop the transaction.
