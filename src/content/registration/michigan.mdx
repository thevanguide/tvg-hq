...
> "Motor home" means a motor vehicle constructed or altered to provide living quarters, including permanently installed cooking and sleeping facilities, and is utilized for recreational, camping, or other noncommercial use.
...
A motor home also falls under Michigan's broader "recreational vehicle" definition in [MCL 257.49a](https://www.legislature.mi.gov/Laws/MCL?objectName=mcl-257-49a), which defines a recreational vehicle as "a new or used vehicle that has its own motive power or is towed by a motor vehicle; is primarily designed to provide temporary living quarters for recreational, camping, travel, or seasonal use." This section explicitly lists motor homes as one type of recreational vehicle.

The statute was added by 1976 PA 26, effective February 27, 1976, and has not been substantively amended since. It remains the controlling definition for how the Secretary of State classifies motor homes for titling and registration.
...
If you are transferring a title from out of state, you may also need a VIN verification. Michigan requires a [TR-54 (Verification of Vehicle Identification Number)](https://www.michigan.gov/sos/resources/forms) for out-of-state vehicles being titled in Michigan for the first time. This verification can be performed by a Michigan law enforcement officer or a licensed Michigan dealer.
...
1. Present your TR-11 application with the body type listed as **motor home**.
...
Motor homes in Michigan are registered the same way as passenger cars. You will receive a standard passenger plate at the branch when you complete the transaction. Registration is issued based on your birthday month, with annual renewal.
...
| Fee | Amount | Source |
|-----|--------|--------|
| Title fee | $15 | [MCL 257.233](https://www.legislature.mi.gov/Laws/MCL?objectName=mcl-257-233) |
| Late title transfer penalty | $15 (if transferred more than 15 days after sale) | [Michigan SOS](https://www.michigan.gov/sos/vehicle/titles) |
...
| Plate transfer fee | $10 | [MCL 257.809](https://www.legislature.mi.gov/Laws/MCL?objectName=MCL-257-809) |

### How the Registration Fee Is Calculated

For vehicles with a model year of 1984 or newer, Michigan uses an **ad valorem** (value-based) registration fee system under [MCL 257.801(1)(p)](https://www.legislature.mi.gov/Laws/MCL?objectName=mcl-257-801). The fee is calculated as a percentage of the vehicle's original MSRP (manufacturer's suggested retail price), declining over four fee levels:

- **Level 0** (first registration): Based on full MSRP
- **Level 1** (second year): Approximately 90% of the Level 0 fee
- **Level 2** (third year): Approximately 90% of the Level 1 fee
- **Level 3** (fourth year and beyond): Approximately 90% of the Level 2 fee, and the fee stays at this level permanently
...
Michigan also has **no mandatory safety inspection** for standard titled vehicles. The only vehicles that require an inspection in Michigan are [salvage vehicles](https://www.michigan.gov/sos/vehicle/abandoned-vehicles) being returned to road use, which must pass a police inspection of the VIN and major components.
...
- [ ] Completed TR-11 (Application for Michigan Vehicle Title) with "motor home" body type
- [ ] Current vehicle title (Michigan or out-of-state)
- [ ] TR-54 (VIN Verification), if titling an out-of-state vehicle for the first time
...
- [Michigan SOS — Forms and Publications](https://www.michigan.gov/sos/resources/forms) — TR-11, TR-54, and other forms
