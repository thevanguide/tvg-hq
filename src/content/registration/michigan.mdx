...
- **Level 1** (second year): 90% of the Level 0 fee
- **Level 2** (third year): 90% of the Level 1 fee
- **Level 3** (fourth year and beyond): 90% of the Level 2 fee, and the fee stays at this level permanently
...
- [ ] TR-54 (Vehicle Number and Equipment Inspection), if titling an out-of-state vehicle for the first time
