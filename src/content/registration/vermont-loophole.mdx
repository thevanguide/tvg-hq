...
description: "Vermont's registration loophole closed in 2023 and tightened again in 2024. What the current rules say, who can still use it, and what works instead."
...
On July 1, 2023, Vermont's Department of Motor Vehicles added a new requirement for any vehicle registration submitted with an out-of-state address or under a power of attorney: a completed **[Form VN-102, Out-of-State Registration Certification](https://dmv.vermont.gov/registrations/new/moving-to-vermont/registering-a-vehicle-without-a-vermont-address)**. VN-102 is not a form you fill out yourself. It has to be completed by your home state's DMV (or the equivalent state vehicle agency) and must certify that your home state does **not** require you to register the vehicle there.
...
**[Act No. 165 of 2024](https://legislature.vermont.gov/Documents/2024/Docs/ACTS/ACT165/ACT165%20As%20Enacted.pdf)**, which took effect July 1, 2024, eliminated that exemption. Under the current law, all vehicle registrations involving an ownership change now receive a Vermont title, regardless of model year. Vehicles that were already registered under the pre-2024 exemption remain exempt as long as ownership does not change, but any sale or transfer after July 1, 2024 triggers a title requirement.
...
1. **[Form VD-119](https://dmv.vermont.gov/sites/dmv/files/documents/VD-119-Vehicle_Registration_Tax_Title.pdf) — Registration, Tax and Title Application.** The main application, completed by the owner. This includes vehicle information, declared purchase price, signature, and a physical address. A PO box or commercial mail receiving address alone is not sufficient; Vermont requires a physical address in addition to any mailing address.
2. **[Form VD-119i](https://dmv.vermont.gov/sites/dmv/files/documents/VD-119i-Registration_Tax_Title_Instructions.pdf) — Instructions.** The official instruction sheet for VD-119. Worth reading before filling the form out, because the instructions specify what supporting documentation Vermont expects for each situation.
...
5. **[Purchase and use tax](https://dmv.vermont.gov/tax-title/vehicle-taxation)** payment. Vermont charges 6 percent of the purchase price or the J.D. Power clean trade-in value, whichever is greater, minus the value of any trade-in.
6. **[Registration fees](https://dmv.vermont.gov/registrations/fees).** As of 2026, passenger vehicles, motorhomes, and light trucks are in the $91 one-year / $167 two-year fee tier, with an additional title fee (roughly $35 under current schedules) and a mandatory $2 Clean Air Fund fee. New vehicles carry an additional $8 warranty fee. Exact figures are published on the Vermont DMV fee schedule and should be confirmed at the time of application.
...
- Related: [Van Conversion Registration Overview](/registration/), [California Van Registration Guide](/registration/california/), [Montana LLC Registration Strategy](/registration/montana-llc/), [RVIA Certification Explained](/certification/rvia/), [Best Insurance for Van Conversions](/insurance/best-for-van-conversions/), [How to Finance a Van Conversion](/financing/)
