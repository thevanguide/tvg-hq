...
Three DMV forms are in play. Only one is strictly required.

**REG 256A — Miscellaneous Certifications.** This is the primary document. Complete the "Certification of Vehicle for Human Habitation" section, which is where you attest that the vehicle has been permanently altered for habitation. This single section is what triggers the body type change in the DMV's system.

**REG 256 — Statement of Facts.** Section E is the "Statement for Vehicle Body Change." Some DMV offices ask for this, some do not. Bring it filled out so you are not making a second trip if yours does.

**REG 343 — Application for Title or Registration.** Standard application for a new title. Required if the DMV is issuing a new title document at the end of the process, which it typically does.

All three forms are available as PDFs from the California DMV forms page.

### The VLF Trap on REG 256A

This is the single most important line in this article. The REG 256A form has value fields that are pre-printed with "$0.00." These fields ask about the cost or value of the conversion.

**Do not voluntarily fill in those fields unless the DMV specifically asks you to.**

Here is why. California charges a Vehicle License Fee of 0.65 percent of the vehicle's market value, annually, for the life of the registration. If you write "$30,000" in the conversion value field, the DMV can and often will re-class your vehicle at the new total value. A $40,000 van plus a $30,000 build becomes a $70,000 vehicle for VLF purposes. That is roughly $195 more per year in registration fees, every year, compared to a $40,000 base.

The form's habitation certification section does not require a conversion value. The inspector is confirming habitation, not auditing your build budget. Leave the value fields as pre-printed and let the DMV ask if they need to. In most reclassifications, they do not.
...
Gather your documents. You need the California Certificate of Title (the pink slip), your current registration, a completed REG 256A, and a completed REG 256 as backup. If your van is financed and the lender holds the title, call the lender and ask them to send the title directly to your local DMV office. This can take two to six weeks and is the single most common cause of delay in the reclassification process. Start this step early.

Photos of the build and receipts for major components are worth bringing, though in most cases the DMV does not ask for them. If a first-time clerk or supervisor wants additional proof of a permanent conversion, photos help. Receipts are better left in a folder unless specifically requested, for the VLF reason above.
...
For most Sprinter, Transit, and ProMaster conversions under 14,000 pounds GVWR, the rules are the same after reclassification as before. Biennial smog check at a STAR station if the vehicle is six or more model years old, $30 to $75 at the test site.

The one thing to be aware of is CARB's **Clean Truck Check program**, which took effect January 1, 2025. Diesel vehicles over 14,000 pounds GVWR — including diesel motorhomes in that weight class — now require annual compliance testing by a CARB-credentialed tester and must pay annual fees through the CTC-VIS system. There is no low-use exemption. Non-compliance results in DMV registration holds.
...
- [ ] Completed REG 256A (habitation certification section only, value fields left as pre-printed)
- [ ] Completed REG 256 (Section E, as backup)
- [ ] Completed REG 343 (if requested)
- [ ] Photo ID
