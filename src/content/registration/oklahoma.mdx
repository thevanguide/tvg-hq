...
- **[Application for Oklahoma Certificate of Title (Form 701-6)](https://oklahoma.gov/content/dam/service-oklahoma/Documents/mv-forms/701-6%20Vehicle-Trailer-Manuf%20Home%20Certificate%20of%20Title.pdf)** — The standard title application form.
- **Verification of liability insurance** — Oklahoma requires minimum liability coverage of [25/50/25](https://www.oid.ok.gov/consumers/auto-insurance/) ($25,000 bodily injury per person, $50,000 per accident, $25,000 property damage).
- **Government-issued photo ID**
- **[Odometer Disclosure Statement (Form 729)](https://oklahoma.gov/service/all-services/auto-vehicle/new-used-vehicle-registration.html)** — Required for motor vehicles from model year 2011 or newer.
- **VIN inspection** — A [VIN verification](https://oklahoma.gov/service/all-services/auto-vehicle/vehicle-titles.html) is required for vehicles being titled in Oklahoma for the first time from out of state. This is a simple VIN check performed by a Service Oklahoma agent or licensed tag agent, not a mechanical inspection.

Under the [Mason Treat Act](https://oklahoma.gov/service/all-services/auto-vehicle/new-used-vehicle-registration.html) (effective September 1, 2024), you have two months from the date of purchase to complete titling and registration. Pre-registration is required within two business days of purchase, and metal plates must be affixed within 10 days.

### Step 3: Visit a Tag Agency

Take your documents to a [Service Oklahoma location or licensed tag agency](https://oklahoma.gov/service/all-services/auto-vehicle.html). Request the title to reflect the recreational vehicle classification. The tag agent will process the title application and issue registration.

Note: As of July 1, 2025, all Oklahoma titles are [issued electronically](https://oklahoma.gov/service/all-services/auto-vehicle/vehicle-titles.html). If a lienholder is listed, the electronic title is held by the lienholder.
...
| Excise tax (new vehicles) | 3.25% of purchase price | [Title 68, Section 2103](https://www.oscn.net/applications/oscn/DeliverDocument.asp?CiteID=440208) |
| Excise tax (used vehicles) | $20 on first $1,500 + 3.25% on remainder | [Title 68, Section 2103](https://www.oscn.net/applications/oscn/DeliverDocument.asp?CiteID=440208) |
...
The excise tax is assessed at the time of titling. For used vehicle purchases, the first $1,500 of value is taxed at a flat $20, and the remaining value above $1,500 is taxed at 3.25%. Under [Title 68, Section 2104](https://www.oscn.net/applications/oscn/DeliverDocument.asp?CiteID=438854), the taxable value is the actual sales price as stated on the bill of sale.
...
- [ ] Completed [Form 701-6](https://oklahoma.gov/content/dam/service-oklahoma/Documents/mv-forms/701-6%20Vehicle-Trailer-Manuf%20Home%20Certificate%20of%20Title.pdf) (Application for Certificate of Title)
- [ ] Proof of Oklahoma liability insurance (25/50/25 minimum)
- [ ] Valid government-issued photo ID
- [ ] [Form 729](https://oklahoma.gov/service/all-services/auto-vehicle/new-used-vehicle-registration.html) (Odometer Disclosure Statement) if vehicle is 2011 or newer
...
- [Oklahoma Statutes Title 68, Section 2103](https://www.oscn.net/applications/oscn/DeliverDocument.asp?CiteID=440208) — Motor vehicle excise tax rates
- [Oklahoma Statutes Title 68, Section 2104](https://www.oscn.net/applications/oscn/DeliverDocument.asp?CiteID=438854) — Vehicle valuation for excise tax purposes
...
- [Service Oklahoma: New & Used Vehicle Registration](https://oklahoma.gov/service/all-services/auto-vehicle/new-used-vehicle-registration.html) — Registration process overview, Mason Treat Act deadlines, required documents
- [Application for Oklahoma Certificate of Title (Form 701-6)](https://oklahoma.gov/content/dam/service-oklahoma/Documents/mv-forms/701-6%20Vehicle-Trailer-Manuf%20Home%20Certificate%20of%20Title.pdf) — Title application form
- [Oklahoma Insurance Department: Auto Insurance](https://www.oid.ok.gov/consumers/auto-insurance/) — Minimum liability coverage requirements (25/50/25)
