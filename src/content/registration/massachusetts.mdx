...
- **Current title** — The existing title for the base vehicle (Massachusetts or out-of-state). Passenger vehicles with a model year of 1980 or older that were purchased before November 26, 1990, are [exempt from titling](https://www.mass.gov/vehicle-certificate-of-title). All other vehicles must be titled.
...
| Fee | Amount | Source |
|-----|--------|--------|
| Title fee | $75 | [RMV: Apply for Registration and Title (Private Sale)](https://www.mass.gov/how-to/apply-for-a-registration-and-title-for-a-vehicle-purchased-from-an-individual) |
| Registration fee (annual, Auto Home Normal plate) | $50 | [RMV Fee Schedule](https://www.mass.gov/info-details/massachusetts-registry-of-motor-vehicles-fees) (AHN not listed on the web page; AHV listed at $50 reg + $50 vanity = $100; AHN confirmed at $50 by [Johnson and Rohan Insurance](https://johnsonandrohan.com/camper-plates-or-trailer-plates/)) |
...
| Vehicle Age | Percentage of Manufacturer's List Price |
|-------------|-------------------|
...
- [RTA Instruction Guide](https://www.mass.gov/doc/registration-and-title-application-instruction-guide/download) — Camper plate type selection instructions
- [Massachusetts RMV Fee Schedule](https://www.mass.gov/info-details/massachusetts-registry-of-motor-vehicles-fees) — Registration fees (note: AHN not listed on web page; only AHV shown)
- [Johnson and Rohan Insurance: Camper Plates or Trailer Plates?](https://johnsonandrohan.com/camper-plates-or-trailer-plates/) — Detailed AHN/AHR/AHV plate types, fees, sink/toilet requirement, and expiration dates (Massachusetts insurance agency)
