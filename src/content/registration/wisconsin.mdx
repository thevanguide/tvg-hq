...
| County sales tax | 0.5%–0.9% (varies by county) | [WI DOR](https://www.revenue.wi.gov/Pages/SalesAndUse/Home.aspx) |
| Emissions test (if required) | Varies by station | [Wisconsin VIP](https://www.wisconsinvip2.org/) |
...
Wisconsin charges a [5% state sales tax](https://www.revenue.wi.gov/Pages/SalesAndUse/Home.aspx) on vehicle purchases. Most counties that have adopted a county sales tax charge 0.5%, though Milwaukee County charges 0.9% and the City of Milwaukee adds an additional 2%. Not all counties have adopted a county sales tax. Use the [WisDOT Sales Tax Rate Lookup](https://www.revenue.wi.gov/Pages/SalesAndUse/Home.aspx) to confirm the rate for your location.
...
- Vehicles are exempt for the first three model years (testing begins in the [4th year after the vehicle's model year](https://docs.legis.wisconsin.gov/statutes/statutes/110/20))
...
Wisconsin requires minimum liability insurance of [$25,000 per person / $50,000 per accident for bodily injury and $10,000 for property damage](https://docs.legis.wisconsin.gov/statutes/statutes/344/iii/33) per [Wis. Stat. 344.33](https://docs.legis.wisconsin.gov/statutes/statutes/344/iii/33). Separately, [Wis. Stat. 632.32](https://docs.legis.wisconsin.gov/statutes/statutes/632/iv/32) requires all auto policies to include uninsured motorist coverage of at least $25,000 per person / $50,000 per accident.
...
- [ ] Current vehicle title (Wisconsin or out-of-state)
- [ ] Completed MV1 application (or plan to use the [online portal](https://mv1.wi.gov/))
- [ ] Bill of sale (if recently purchased)
- [ ] Valid Wisconsin driver's license or identification
...
- [Wis. Stat. 110.20 — Vehicle inspection program](https://docs.legis.wisconsin.gov/statutes/statutes/110/20) — Emissions inspection program rules, including 4th-year testing start
- [Wis. Stat. 344.33 — Minimum liability insurance](https://docs.legis.wisconsin.gov/statutes/statutes/344/iii/33) — Required liability coverage amounts
- [Wis. Stat. 632.32 — Uninsured motorist coverage](https://docs.legis.wisconsin.gov/statutes/statutes/632/iv/32) — Required uninsured motorist coverage amounts
- [Wis. Stat. 77.52 — State sales tax](https://docs.legis.wisconsin.gov/statutes/statutes/77/iii/52) — 5% state sales tax rate
