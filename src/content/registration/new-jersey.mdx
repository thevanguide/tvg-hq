...
Before you can request a body type change, you must hold a New Jersey title in your name. If you purchased the vehicle out of state, you will need to [transfer the title to New Jersey](https://www.nj.gov/mvc/vehicles/transowner.htm) first.
...
- Payment for title fee ($60, or $85 with a lien)
...
Prepare and send the following via **certified mail** to:

**NJ-MVC Foreign Titles**
225 East State St, Box 017
Trenton, NJ 08666
...
The MVC Foreign Title unit will review your submission and, if approved, issue a new title with the motor home body type. Processing times vary, but expect several weeks to a few months. For questions during processing, contact the Foreign Title unit at **(609) 292-6500 ext. 5064**.
...
| Fee | Amount | Source |
|-----|--------|--------|
| Title fee | $60 ($85 with lien) | [NJ MVC Fees](https://www.nj.gov/mvc/vehicles/regfees.htm) |
| Body type change fee | $60 ($85 with lien) | [NJ MVC](https://www.nj.gov/mvc/vehicles/motorhomes.htm) |
| Registration fee (passenger) | $35–$84/year (weight-based) | [NJ MVC Fees](https://www.nj.gov/mvc/vehicles/regfees.htm) |
| License plates | $6 | [NJ MVC Fees](https://www.nj.gov/mvc/vehicles/regfees.htm) |
...
- **Newly purchased vehicles** (in-state): Title within **10 days** to avoid penalty fees, per the [NJ MVC](https://www.nj.gov/mvc/vehicles/titlenew.htm).
- **Out-of-state vehicles**: Title and register within **60 days** of establishing New Jersey residency.
- Mobile homes specifically must be titled within 10 days.
...
**Diesel-powered vehicles** follow a separate set of rules. New Jersey [ceased tailpipe emissions testing](https://www.nj.gov/mvc/inspection/tailpipe.htm) in 2021 and now uses OBD-II (On-Board Diagnostics) testing for emissions compliance.
...
Exempt vehicle owners should keep an exemption certificate with the vehicle.
...
- [ ] Bill of sale
- [ ] Proof of NJ liability insurance
- [ ] Valid NJ driver's license
- [ ] Payment for title fee ($60/$85) and sales tax (6.625%)
...
Mail via certified mail to: NJ-MVC Foreign Titles, 225 East State St, Box 017, Trenton, NJ 08666
...
- [NJ MVC — Mobile Homes, Motor Homes and Station Wagons](https://www.nj.gov/mvc/vehicles/motorhomes.htm) — Motor home titling and body type change process
...
- [NJ MVC — Transferring Vehicle Ownership](https://www.nj.gov/mvc/vehicles/transowner.htm) — Out-of-state title transfer
...
- [NJ MVC — Cessation of Tailpipe Emission Testing](https://www.nj.gov/mvc/inspection/tailpipe.htm) — Current emissions testing method
