...
**Diesel-powered vehicles** follow a separate set of rules. New Jersey [ceased tailpipe emissions testing](https://www.nj.gov/mvc/inspection/tailpipe.htm) on May 1, 2016. Vehicles that previously required only tailpipe testing and fall within the exempt weight/model-year categories listed above no longer require any inspection.
