...
| **License plate fee (house car)** | $23 to $500+ (varies by gross vehicle weight) | [ADOR Registration Fees](https://www.revenue.alabama.gov/tax-types/motor-vehicle-registration-fees/) |
...
2. **The assessed value** is a percentage of the market value. Self-propelled campers and house cars fall under **Class II** at a **20% assessment rate** for state purposes per [Alabama Code Section 40-12-253](https://law.justia.com/codes/alabama/title-40/chapter-12/article-5/division-1/section-40-12-253/).
...
Alabama does not require safety inspections or emissions testing for vehicle registration. According to the [Alabama Department of Revenue](https://www.revenue.alabama.gov/faqs/are-emissions-testing-a-prerequisite-to-registration/), emissions testing is not a prerequisite to vehicle registration in the state. While Alabama law technically allows individual cities to implement emissions testing programs, no city or county currently requires it.
